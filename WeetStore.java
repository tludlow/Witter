...
public class WeetStore implements IWeetStore {
    ...
    class Trend implements Comparable<Trend> {
        ...
        //Standard getters for the trends.
        ...
        //incremement the number of times the trend has been weeted and then update the date given in the argument (the weets date passed into the object)
